...
var answer = [
{'山西省安全生产条例自起施行分值分': '2023年3月1日'}, {'从业人员应严格落实岗位安全生产责任遵守本单位的安全生产规章制度和操作规程服从管理正确使用分值分': '劳动防护用品'}, {'从业人员未经合格不得上岗作业分值分': '安全生产培训'}, {'生产经营单位应当建立从业人员安全生产教育和培训档案如实记录安全生产教育和培训的时间内容参加人员以及考核结果等情况记录保存期限不得少于年分值分': '三'}, {'双重预防机制包括分值分': '安全风险分级管控┋隐患排查治理'}, {'从业人员应接受增强事故预防和应急处置能力分值分': '安全生产教育培训┋参加应急演练┋提高安全生产技能'}, {'从业人员应严格落实岗位安全生产责任遵守本单位的服从管理正确使用劳动防护用品分值分': '安全生产规章制度┋操作规程'}, {'从业人员的上岗前应当重新组织安全生产教育和培训分值分': '离岗一年以上┋换岗'}, {'生产经营单位应当建立从业人员安全生产教育和培训档案如实记录安全生产教育和培训的等情况记录保存期限不得少于三年分值分': '时间┋内容┋参加人员┋考核结果'}, {'生产经营单位对从业人员安全生产教育和培训的主要内容有分值分': '安全生产法律、法规和政策┋安全生产规章制度和操作规程┋生产安全事故案例警示教育┋作业场所和工作岗位存在的危险有害因素以及应急救援、自救互救等防范措施'}, {'生产经营单位对从业人员安全生产教育和培训的主要内容有分值分': '作业场所职业危害及其预防措施┋安全设备、设施、劳动防护用品的使用、维护和保养┋其他需要培训的安全生产内容┋从业人员在安全生产方面的权利和义务'}, {'生产经营单位可以安排未经安全生产培训合格的从业人员上岗作业分值分': '错'}, {'从业人员应参加安全生产教育和培训掌握工作岗位所必需的安全生产知识和技能分值分': '对'}, {'从业人员应接受安全生产教育培训参加应急演练提高安全生产技能增强事故预防和应急处置能力分值分': '对'}, {'从业人员应严格落实岗位安全生产责任遵守本单位的安全生产规章制度和操作规程服从管理正确使用劳动防护用品分值分': '对'},
  ...
  },
  {
    有行为时铁路运输企业除按规定补票外还需加收已乘区间应补票价的票款分值分:
      "A.无票乘车且未主动补票时，补收自乘车站（不能判明时自始发站）起至到站止的车票票款。┋B.持用变造、伪造或涂改的乘车凭证乘车时，除按无票处理外并送交公安部门处理。┋C.票、证、人不一致的，按无票处理。┋D.持失效车票乘车或在车票到站后不下车继续乘车的，按无票处理。",
  },
  {
  ...
  {
    有行为时铁路运输企业除按规定补票外还需加收已乘区间应补票价的票款分值分:
      "A.旅客持优惠票、优待票，没有规定的减价凭证或不符合减价条件时，按照全价票价补收票价差额。┋B.持用变造、伪造或涂改的乘车凭证乘车时，除按无票处理外并送交公安部门处理。┋C.票、证、人不一致的，按无票处理。┋D.持用低票价席别车票乘坐高票价席别时，补收所乘区间的票价差额。",
  },
  {
    有行为时铁路运输企业除按规定补票外还需加收已乘区间应补票价的票款分值分:
